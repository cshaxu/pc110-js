...
| 0F decode and system groups                           | 5141, 11629-12637                            | Escape decoding, descriptor/table, CR/DR/TR, LAR/LSL, CLTS                       | `decode/decoder.ts`, `instructions/system.ts`                                                                                                                                                   | Partial                     | CPL; descriptor faults; 16/default-32; 66/67                  | Required        | Implemented NXVM handler coverage for 00-26: P380-P390, P400, P415-P416, P428, P445, P448-P449; other 0F intervals remain separate |
...
## P449 LLDT/LTR Paging-Fault Checklist

P449 applies the same selector-versus-memory distinction to the NXVM
`_s_load_ldtr` and `_s_load_tr` path. Rebuilt LLDT/LTR convert only
descriptor-table lookup errors into `#GP(selector)`; a real GDT paging fault
